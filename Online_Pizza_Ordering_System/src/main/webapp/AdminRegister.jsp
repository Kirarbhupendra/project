...
<form action="<%=request.getContextPath() %>/adminregister" method="post" class="form-container">
  ...
  <div class="form-field">
    <input name="employeeid" id="InputEmpoyeeid" placeholder="Employee ID" required>
  </div>
  ...
  <div class="form-field">
    <input name="lastname"    id="InputName" placeholder="Last Name" required>   </div>
  ...
  <div class="form-field">
    <input type="email" name="email"    id="exampleInputEmail1" placeholder="Email" required>  </div>

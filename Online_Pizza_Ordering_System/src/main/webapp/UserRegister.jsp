	...
	<form action="<%=request.getContextPath() %>/userregister" method="post" class="form-container">
			...
			<div class="form-group">
				<label for="InputFirstName">First Name</label>
					<input name="firstname" class="form-control" id="InputName" placeholder="Name" required> 
			</div>
			<div class="form-group">
				<label for="InputLastName">Last Name</label>
					<input name="lastname" class="form-control" id="InputName" placeholder="Name" required> 
			</div>
			<div class="form-group">
